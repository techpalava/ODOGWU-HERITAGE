...
assert.match(fabricSource, /aria-label=\{`Change fabric for \$\{garmentLabel\}`\}/);
assert.match(fabricSource, /aria-label=\{`Add fabric for \$\{garmentLabel\}`\}/);
assert.match(fabricSource, /aria-label=\{`Assign fabric for \$\{garmentLabel\}`\}/);
