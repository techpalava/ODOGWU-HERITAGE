...
> = {
  ...
  standard_shorts_fastening: "Nikka/Standard Shorts Fastening",
  standard_shorts_pockets: "Nikka Pockets",
...
{
    id: "shorts_std_rope_elastic",
    label: "With Rope Plus Elastic Band",
    description: "Shorts ending just above the knee with a drawstring rope plus an elastic waistband.",
    priceCents: 8500,
    garmentGroup: "standard_shorts",
    eligibleDemographics: ["male", "unisex"],
    selectionGroup: "standard_shorts_fastening",
  ...
  },
{
    id: "bum_rope_elastic",
    label: "With Rope Plus Elastic Band",
    description: "Shorts ending just below the crotch at lap level with a drawstring rope plus an elastic waistband.",
    priceCents: 8500,
    garmentGroup: "bum_shorts",
    eligibleDemographics: ["male", "female", "unisex"],
    selectionGroup: "bum_shorts_fastening",
...
{
    id: "trouser_rope_elastic",
    label: "With Rope Plus Elastic Band",
    description: "Full-length trousers extending to the ankle with a drawstring rope plus an elastic waistband.",
    priceCents: 8500,
    garmentGroup: "trousers",
    eligibleDemographics: ["male", "unisex"],
    selectionGroup: "trouser_fastening",
