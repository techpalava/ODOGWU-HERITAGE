...
import { Compass, Shirt, ClipboardList, Layers, Info, Database, ShoppingCart, Menu, MessageCircle } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <div
            ...
            className="flex items-center gap-2.5 sm:gap-3 cursor-pointer select-none min-w-0 max-w-[55%] sm:max-w-none"
          >
            <img loading="lazy"
              src={odogwuLogo}
              alt="The Odogwu Heritage Logo"
              className="w-12 h-12 sm:w-11 sm:h-11 rounded-full border border-heritage-gold/35 object-cover bg-heritage-forest shrink-0 shadow-md"
            ...
            <div className="flex flex-col min-w-0">
              ...
              <div className="block sm:hidden leading-[1.1] uppercase">
                <span className="block text-[12px] font-bold tracking-[0.12em] text-heritage-gold font-display">THE ODOGWU</span>
                <span className="block text-[12px] font-bold tracking-[0.12em] text-heritage-gold font-display">HERITAGE</span>
                <span className="block text-[11px] tracking-[0.15em] text-white font-sans font-medium mt-0.5">NTCC</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex lg:hidden items-center gap-2 sm:gap-2.5">
            ...
            >
              ...
              <span className="text-[9px] font-bold uppercase tracking-wider hidden sm:inline">Cart</span>
              {cartItemsCount > 0 && (
